      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <div className="flex items-center space-x-3">
            ...
            <span className="text-xs font-mono text-platinum-dark bg-slate-100 px-2 py-0.5 rounded border">#{item.item_no || item.id}</span>
            ...
            <div className="bg-white border border-platinum-dark rounded-card p-4 shadow-sm-subtle">
              ...
              <div className="flex space-x-3">
                <textarea value={activityText} onChange={e => setActivityText(e.target.value)} rows={2}
                  ...
                  className="flex-1 bg-slate-50 border border-platinum-dark rounded-xl p-3 text-sm focus:outline-none focus:border-navy resize-none" />
            ...
            <div className="p-3 border-t border-platinum-dark">
              {showChecklistForm ? (
                ...
                <button onClick={() => setShowChecklistForm(true)}
                  className="w-full py-2 text-xs font-semibold text-navy hover:bg-blue-50 border border-dashed border-blue-200 rounded-xl transition-colors">
          ...
          <div className="bg-white rounded-2xl w-full max-w-sm shadow-xl p-5 border border-platinum-dark">
            ...
            <div className="mb-4">
              ...
              <select 
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-sm focus:outline-none focus:border-navy"
              >
