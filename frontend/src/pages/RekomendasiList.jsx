          ...
          {loading ? (
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-platinum-dark text-sm">
                {rekomendasi.map((rek) => (
                  <tr key={rek.id} className="hover:bg-platinum/50 transition-colors">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="bg-white rounded-card shadow-lg w-full max-w-2xl max-h-[90vh] flex flex-col">
            <div className="p-6 border-b border-platinum-dark flex items-center justify-between">
              <div>
                <h3 className="text-lg font-bold text-ink">Detail Rekomendasi</h3>
                <p className="text-xs text-platinum-dark">{selectedRek.notification}</p>
              </div>
              <button
            ...
            <div className="p-6 overflow-y-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    <p className="text-xs text-platinum-dark font-bold uppercase tracking-wider mb-1">Notification</p>
                    <p className="text-sm font-medium text-ink">{selectedRek.notification}</p>
                  </div>
                  <div>
                    <p className="text-xs text-platinum-dark font-bold uppercase tracking-wider mb-1">Tipe Notification</p>
                    <p className="text-sm font-medium text-ink">{selectedRek.notification_type || '-'}</p>
                  </div>
                  <div>
                    <p className="text-xs text-platinum-dark font-bold uppercase tracking-wider mb-1">Dilaporkan Oleh (Reported By)</p>
                    <p className="text-sm font-medium text-ink">{selectedRek.reported_by || '-'}</p>
                  </div>
                  <div>
                    <p className="text-xs text-platinum-dark font-bold uppercase tracking-wider mb-1">Status Internal</p>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <p className="text-xs text-platinum-dark font-bold uppercase tracking-wider mb-1">Functional Location</p>
                ...
                {selectedRek.order && (
                  <div className="col-span-1 md:col-span-2">
                    <p className="text-xs text-platinum-dark font-bold uppercase tracking-wider mb-1">Work Order Terkait</p>
                    <p className="text-sm font-medium text-ink bg-navy/10 text-navy inline-block px-3 py-1 rounded-lg border border-navy/20">
                      {selectedRek.order}
                    </p>
                  </div>
                )}
                ...
                <div className="col-span-1 md:col-span-2">
                  <p className="text-xs text-platinum-dark font-bold uppercase tracking-wider mb-1">Deskripsi Masalah</p>
