        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
          <div className="bg-white rounded-lg shadow-lg w-full max-w-2xl max-h-[90vh] flex flex-col">
            <div className="p-6 border-b border-gray-200 flex items-center justify-between">
              <div>
                <h3 className="text-lg font-display font-bold text-ink">Detail Work Order</h3>
                <p className="text-xs text-gray-500">{selectedWO.nomor_wo}</p>
              </div>
              <button
            ...
            <div className="p-6 overflow-y-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-4">
                  <div>
                    <p className="text-xs text-gray-500 font-bold uppercase tracking-wider mb-1">Nomor WO</p>
                    <p className="text-sm font-medium text-ink">{selectedWO.nomor_wo}</p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-500 font-bold uppercase tracking-wider mb-1">Operation / Activity</p>
                    <p className="text-sm font-medium text-ink">{selectedWO.operation_activity}</p>
                  </div>
                  <div>
                    <p className="text-xs text-gray-500 font-bold uppercase tracking-wider mb-1">Tipe PM</p>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <p className="text-xs text-gray-500 font-bold uppercase tracking-wider mb-1">Work Center</p>
                ...
                <div className="col-span-1 md:col-span-2">
                  <p className="text-xs text-gray-500 font-bold uppercase tracking-wider mb-1">Deskripsi / Judul Pekerjaan</p>
