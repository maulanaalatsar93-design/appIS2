  ...
  return (
    <div className="p-6 w-full max-w-none space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-display font-bold text-ink mb-2">Perencanaan Manpower</h1>
          <p className="text-gray-500 text-sm">Kelola rencana penempatan personel untuk program pabrik dan pantau proses persetujuan.</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white border border-gray-200 rounded-lg p-4 flex items-start space-x-4 shadow-sm-subtle">
          <div className="w-10 h-10 rounded-lg bg-blue-50 flex items-center justify-center shrink-0">
            <FileText className="w-5 h-5 text-navy-600" />
          </div>
          <div>
            <p className="text-xs font-medium text-gray-500">Total Rencana</p>
            <p className="text-2xl font-display font-bold text-ink mt-1">{plans.length}</p>
          </div>
        </div>
        <div className="bg-white border border-gray-200 rounded-lg p-4 flex items-start space-x-4 shadow-sm-subtle">
          ...
          <div>
            <p className="text-xs font-medium text-gray-500">Menunggu Approval</p>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 flex items-start space-x-4 shadow-sm-subtle">
          ...
          <div>
            <p className="text-xs font-medium text-gray-500">Disetujui</p>
            <p className="text-2xl font-display font-bold text-ink mt-1">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4 flex items-start space-x-4 shadow-sm-subtle">
          ...
          <div>
            <p className="text-xs font-medium text-gray-500">Perlu Perhatian</p>
            <p className="text-2xl font-display font-bold text-ink mt-1">
      ...
      <div className="bg-white border border-gray-200 rounded-lg overflow-hidden shadow-md">
        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center p-12 text-gray-500">
            ...
            <p className="text-sm font-medium text-gray-500">Belum ada dokumen perencanaan.</p>
                ...
                {plans.map((plan) => (
                  <tr key={plan.id} className="hover:bg-slate-50 transition-colors group">
                    <td className="px-4 py-3">
                      ...
                      <p className="text-xs text-gray-500 mt-0.5">Pembuat: {plan.createdBy.name}</p>
                    </td>
                    <td className="px-4 py-3">
                    ...
                    <td className="px-4 py-3">
                      ...
                      <p className="text-xs text-gray-500 mt-0.5">{plan.area}</p>
                    </td>
                    <td className="px-4 py-3">
                    ...
                    <td className="px-4 py-3 text-right">
                      <button 
                        ...
                        className="p-1.5 bg-blue-50 text-navy-600 hover:bg-blue-100 rounded-lg transition-colors border border-blue-200 inline-flex items-center"
                        title="Lihat Detail"
                      >
