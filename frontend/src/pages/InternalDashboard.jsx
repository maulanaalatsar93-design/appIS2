              ...
              <div className="px-1">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex items-center gap-1">
                    {(summary?.jobLoadDetails?.gauges?.allWOCnfRate || 0) >= 90 && <CheckCircle2 className="w-3.5 h-3.5 text-green-500" />}
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="px-1">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex items-center gap-1">
                    {(summary?.jobLoadDetails?.gauges?.pm04CnfRate || 0) >= 90 && <CheckCircle2 className="w-3.5 h-3.5 text-green-500" />}
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="px-1">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <div className="flex items-center gap-1">
                    {(summary?.jobLoadDetails?.gauges?.pm02PlusCnfRate || 0) >= 90 && <CheckCircle2 className="w-3.5 h-3.5 text-green-500" />}
                      ...
                      <tr key={idx} className="hover:bg-gray-50/50 transition-colors">
                        ...
                        <td className="py-3.5 px-5 text-right">
                          <span className={`inline-flex items-center gap-1 px-2.5 py-1 rounded text-[11px] font-bold ${
                            ...
                            {row.capaianCNF >= 90 && <CheckCircle2 className="w-3 h-3 text-green-600" />}
