...
async function main() {
  ...
  const manPowers = [
    ...
    { npk: 'KNE-B-20.103', name: 'Syaharuddin', employee_type: 'Non Organik', division_id: 1, position: 'Rotating 1', is_active: true },
    ...
    { npk: 'K257609', name: 'Arikson', employee_type: 'Non Organik', division_id: 4, position: 'Bengkel', is_active: true },
